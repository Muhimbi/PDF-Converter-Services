# Apply rich watermarks to a PDF using C# .NET Core
...
For background details about applying watermarks to PDF Files using C# (Full .NET Framework, but very similar to .NET Core), see [this Blog post](http://blog.muhimbi.com/2010/06/using-awesome-new-watermarking-features.html).
