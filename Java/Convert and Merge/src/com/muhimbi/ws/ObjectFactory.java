...
public class ObjectFactory {
    ...
    public JAXBElement<String> createLinearBarcodeFontFamilyName(String value) {
        return new JAXBElement<String>(_DefaultsFontFamilyName_QNAME, String.class, LinearBarcode.class, value);
    }
    ...
    public JAXBElement<String> createLinearBarcodeFontSize(String value) {
        return new JAXBElement<String>(_DefaultsFontSize_QNAME, String.class, LinearBarcode.class, value);
    }
